...
/******************************************************************************/
  ...
  //RCC->CR |= ((uint32_t)RCC_CR_HSEON);
		RCC->CR |= ((uint32_t)RCC_CR_HSION); //stragen 2017-3-15
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
		//RCC_CFGR_PLLSRC=0 ; RCC_CFGR_PLLXTPRE=0;RCC_CFGR_PLLMULL=0  by stragen 
    //RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_PREDIV1 | RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLMULL9);
		//RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLMULL2);//PLL=1±¶HSI
		RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLMULL16);//PLL=8±¶HSI,64Mhz
    /* Enable PLL */
    RCC->CR |= RCC_CR_PLLON;
